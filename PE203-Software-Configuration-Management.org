...
- Outline a process model for software development (K2)
- Estimate cost to manage the software development (K3)
- Develop a project using agile and devops software development
  practices (K3)
- Find the activities of security and risk in various types of
  software projects (K1)
- Infer management skills and techniques to develop commercial
